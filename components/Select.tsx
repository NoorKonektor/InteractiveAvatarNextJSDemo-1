...
export function Select<T>(props: SelectProps<T>) {
  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger className="w-full text-gray-900 text-sm bg-white border border-gray-300 py-3 px-4 rounded-lg cursor-pointer flex items-center justify-between h-fit disabled:opacity-50 min-h-[44px] focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            {props.options.map((option) => {
              ...
              return (
                <div
                  ...
                  className={`py-2 px-4 cursor-pointer hover:bg-gray-50 outline-none text-sm ${
